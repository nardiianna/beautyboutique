...
with open("elementor_data_il_centro.json") as f:
...
# look up an existing page with this slug so re-runs update instead of duplicating
lookup_req = urllib.request.Request(
    f"{SITE}/wp-json/wp/v2/pages?slug=il-centro&status=any",
